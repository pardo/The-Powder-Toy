...
#ifdef PIX16
#define PIXELSIZE 2
#define PIXPACK(x) ((((x)>>3)&0x001F)|(((x)>>5)&0x07E0)|(((x)>>8)&0xF800))					//16bit RGB in 16bit int: ????
#define PIXRGB(b,g,r) ((((r)<<8)&0xF800)|(((g)<<3)&0x07E0)|(((b)>>3)&0x001F))
...
#define PIXELSIZE 4
#ifdef PIX32BGRA
#define PIXPACK(x) ((((x)<<16)&0xFF0000)|((x)&0x00FF00)|(((x)>>16)&0x0000FF))				//24bit BGR in 32bit int: 00BBGGRR
#define PIXRGB(b,g,r) (((b)<<16)|((g)<<8)|((r)))// (((b)<<16)|((g)<<8)|(r))
